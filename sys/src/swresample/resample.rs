...
extern {
	...
	pub fn swr_is_initialized(s: *mut SwrContext) -> c_int;
	...
	pub fn swr_next_pts(s: *mut SwrContext, pts: int64_t) -> int64_t;
	...
	pub fn swr_get_delay(s: *mut SwrContext, base: int64_t) -> int64_t;
